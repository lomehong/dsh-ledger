#!/usr/bin/env node
/**
 * 构建 dsh-ledger 客户端插件：src/client/index.tsx → lib/client.js
...
const pkgName = '@dsh-extra/dsh-ledger'
...
const EXTERNALS = [
  ...
  '@deepseek-ai/dsh-client-ui-plugin-manager', '@deepseek-ai/dsh-client-ui-plugin-manager/client',
]
